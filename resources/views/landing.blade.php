...
<html
  ...
  <head>
    ...
    <title>CloneSpeak - Sesin kelimelerden daha fazlasını taşır</title>
  ...
  <body>
          ...
          <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
           <button class="navbar-toggler border-0 text-heading position-absolute end-0 top-0 scaleX-n1-rtl p-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <i class="icon-base ti tabler-x icon-lg"></i>
            ...
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/voice">Uygulama</a>
              </li>
              <li class="nav-item">
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
          ...
          <div class="container">
            <div class="hero-text-box text-center position-relative">
              <h1 class="text-primary hero-title display-6 fw-extrabold">
                Sesin kelimelerden daha fazlasını taşır
              </h1>
              <h2 class="hero-sub-title h6 mb-6">
                {{-- Klonlanmış sesinizle duygularınızı, tonlamanızı <br class="d-none d-lg-block" /> 
              ...
              <div class="landing-hero-btn d-inline-block position-relative">
                ...
                <a href="/voice" class="btn btn-primary btn-lg">Konuş ve Çeviriyi Dinlet</a>
              </div>
            </div>
            <div id="heroDashboardAnimation" class="hero-animation-img">
              <a href="/voice" target="_blank">
                <div id="heroAnimationImg" class="position-relative hero-dashboard-img" style="">
                  <img
      ...
      <section id="landingFeatures" class="section landing-features">
        <div class="container">
